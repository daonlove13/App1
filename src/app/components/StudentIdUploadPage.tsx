    ...
    <div className="mb-5">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          className="text-[12px] text-[#6a7282] font-medium"
        >
          다음 문제 →
        </button>
      </div>
      <div className="border-2 border-[#e5e7eb] rounded-[20px] p-5">
        <p className="text-[15px] font-bold text-center text-[#0a0a0a] mb-4 leading-[22px]">
          {q.q}
        </p>
...
export default function StudentIdUploadPage({ onDone, onBack, defaultState = 'idle' }: Props) {
  const [state, setState] = useState<'idle' | 'uploaded' | 'pending'>(defaultState);
      ...
      <div className="absolute top-[100px] left-0 right-0 bottom-[34px] flex flex-col overflow-hidden">
        ...
        {state !== 'pending' ? (
          ...
          <div className="flex flex-col flex-1 px-5 pt-6">
            ...
            <button
              onClick={handleUpload}
              className="mt-4 w-full bg-black text-white rounded-[14px] py-[15px] text-[15px] font-semibold flex items-center justify-center gap-2"
            >
              <Upload size={16} />
              갤러리에서 선택
            </button>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="flex flex-col items-center pt-5 pb-4 px-5">
              ...
              <p className="text-[14px] text-[#6a7282] text-center leading-[22px]">
                보통{' '}
                <span className="font-semibold text-black">30분 이내</span>로 승인 알림이 와요.<br />
                앱을 종료해도 알림으로 알려드려요.
              </p>
            </div>
            ...
            <div className="mb-5">
              <div className="px-5 mb-2">
                <p className="font-bold text-[16px] text-[#0a0a0a] mb-0.5">
                  제휴 가게 미리보기
                </p>
                <p className="text-[12px] text-[#6a7282]">
                  매칭되면 가기 좋은 학교 근처 가게들
                </p>
              </div>
